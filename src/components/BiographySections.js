    ...
    <div className="bg-[#1b1b1e] p-6 rounded-lg shadow-md text-center">
      ...
      {!expanded ? (
        ...
        <>
          ...
          <h2 className="mt-8 text-3xl font-bold text-white">What I Bring to the Table</h2>
          ...
          <h2 className="mt-8 text-3xl font-bold text-white">Passions and Projects</h2>
          <p className="mt-4 text-lg sm:text-xl lg:text-2xl text-gray-400 max-w-5xl mx-auto">
          ...
          <h2 className="mt-8 text-3xl font-bold text-white">Looking Ahead</h2>
          <p className="mt-4 text-lg sm:text-xl lg:text-2xl text-gray-400 max-w-5xl mx-auto">
